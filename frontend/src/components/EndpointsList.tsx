...
const EndpointsList: React.FC<EndpointsListProps> = ({
 ...
 console.log(selectedEndpoint)
  ...
  const getStatus = (ep: Endpoint) => ep.body ? 'success' : 'success'; // all success for now
  const getResponseTime = () => Math.floor(Math.random() * 200) + 50; // random 50-250ms
  const getId = (idx: number) => idx; // fallback ID
      ...
      {endpoints.map((endpoint, idx) => {
        ...
        return (
          <div
            ...
            style={{
              ...cardStyle,
              borderWidth: selectedEndpoint === endpoint ? '2px' : '1px',
              cursor: 'pointer',
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flex: 1 }}>
                <div style={{
                  ...
                  {status === 'success' ? <CheckCircle size={20} color="white" /> : <XCircle size={20} color="white" />}
                </div>
              ...
              <ChevronRight
                ...
                color="#999"
                style={{
                  transform: selectedEndpoint === endpoint ? 'rotate(90deg)' : 'rotate(0deg)',
